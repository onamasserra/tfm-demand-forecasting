...
\caption{Distribution of forecast errors for Naive, Random Forest, XGBoost, and LightGBM. The tree-based models produce tighter, more symmetric error distributions compared to the naive baseline.}
