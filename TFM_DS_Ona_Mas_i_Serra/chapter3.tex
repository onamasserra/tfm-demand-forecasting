...
\caption{Distribution of per-product RMSE values: Naive vs each tree-based model. All three ML models shift the distribution towards lower RMSE values across the product portfolio.}
