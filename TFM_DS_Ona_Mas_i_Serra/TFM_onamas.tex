...
\gantttitle{TFM Schedule (Feb 19 -- Jun 26, 2026)}{19} \\
\gantttitle{Feb}{1}
\gantttitle{Mar}{4}
\gantttitle{Apr}{4}
\gantttitle{May}{5}
...
\textbf{Present work} & \textbf{Automotive} & \textbf{ARIMA, XGBoost, LightGBM, RF,LSTM} & \textbf{MAE, RMSE, MAPE, $\sigma_e$} & \textbf{Standard + promotional; economic impact} \\
\hline
\end{tabular}
\end{table}
